...
public class HWP1_Etsy_Xpath_CSS {
    public static void main(String[] args) {
        ...
        //burasi akzeptiren butonu, tiklayip devam ediyoruz
        //driver.findElement(By.xpath("//div[.=' Akzeptieren ']")).click();
        driver.findElement(By.xpath("//button[@data-gdpr-single-choice-accept= 'true']")).click();
