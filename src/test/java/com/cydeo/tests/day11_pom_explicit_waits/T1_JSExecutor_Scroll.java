...
public class T1_JSExecutor_Scroll {
    ...
    public void scroll_using_js_executor(){
        ...
        js.executeScript("arguments[0].scrollIntoView(true)", cydeoLink, homeLink ); //0. indexe git

        //4- Scroll up to “Home” link
        BrowserUtils.sleep(2);
        js.executeScript("arguments[1].scrollIntoView(true)", cydeoLink, homeLink );  //1. indexe git
